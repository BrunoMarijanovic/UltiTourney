...
{
    public class UltiTourneyDbContext: IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configurar la relación many-to-many entre ApplicationUser y Tourney a través de UserTourney
            modelBuilder.Entity<UserTourney>()
                .HasKey(ut => new { ut.UserId, ut.TourneyId });

            modelBuilder.Entity<UserTourney>()
                .HasOne(ut => ut.User)
                .WithMany(u => u.UserTourneys)
                .HasForeignKey(ut => ut.UserId);

            modelBuilder.Entity<UserTourney>()
                .HasOne(ut => ut.Tourney)
                .WithMany(t => t.UserTourneys)
                .HasForeignKey(ut => ut.TourneyId);
